...
// Make your own changes to Order.tsx and update the tests to reflect the change.
// Or do the reverse, TDD style.
// Notice how you only have to make test updates that correlate 1-to-1 for each change,
//    unlike traditional tests for which you would need to update many or all the tests.
